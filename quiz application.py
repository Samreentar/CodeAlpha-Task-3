...
questions = ["Which programming language is known for its simplicity and readability?","What does CPU Stand for","Which data structure uses a Last-In-First-Out (LIFO) approach?","What is an example of volatile memory in a computer system?","What is the result of a program's execution called?"]
options = [['c++','Java','Python','C','Python'],['Control processing unit','Central processing unit','Central program unit','Computer performance unit','Central processing unit'],['Queue','Stack','Linked list','Tree','Stack'],['Hard Disk Drive','ROM ','RAM','Solid State Drive','RAM'],['Input','Error','Output','Syntax','Output']]


frame = tk.Frame(root, padx=10, pady=10,bg='#fff')
question_label = tk.Label(frame,height=5, width=28,bg='gray',fg="#fff", 
